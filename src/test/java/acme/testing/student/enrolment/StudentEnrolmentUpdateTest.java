...
public class StudentEnrolmentUpdateTest extends TestHarness {
	...
	public void test100Positive(final int recordIndex, final String code, final String motivation, final String goals, final String workTime, final String isFinished) {
		...
		super.fillInputBoxIn("goals", goals);
		super.fillInputBoxIn("workTime", workTime);
		super.fillInputBoxIn("isFinished", isFinished);
		super.clickOnSubmit("Update");
	...
	public void test200Negative(final int recordIndex, final String code, final String motivation, final String goals, final String workTime, final String isFinished) {
