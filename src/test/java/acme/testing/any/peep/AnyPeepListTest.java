...
public class AnyPeepListTest extends TestHarness {
	...
	public void test100Positive(final int recordIndex, final String title, final String nick) {
		// HINT: this test lists all peeps as an anonymous user an administrator and a lecturer,
