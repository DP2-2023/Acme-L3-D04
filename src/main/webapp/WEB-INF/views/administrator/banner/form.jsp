...
<acme:form readonly="${readonly}">
	<acme:input-moment code="administrator.banner.list.label.displayPeriodStart" path="displayPeriodStart"/>
	<acme:input-moment code="administrator.banner.list.label.displayPeriodEnd" path="displayPeriodEnd"/>
	...
	<acme:input-url code="administrator.banner.list.label.linkTarget" path="linkTarget"/>
